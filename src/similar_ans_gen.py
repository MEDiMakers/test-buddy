...
GENERATE_SIMILAR_ANSWER_PROMPT = """You are an expert in linguistic variation and medical communication. 
...
GENERATE_POOR_ANSWER_PROMPT = """You are an expert in generating misleading and irrelevant content. 
...
def generate_poor_answers(qa_pair, answer_prompt, client):
    ...
    class AnswerList(BaseModel):
        answers: list = Field(
            description="Answer completely different to the provided answer"
        )
